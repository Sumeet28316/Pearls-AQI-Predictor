...
An end-to-end Air Quality Index prediction system for Karachi, built with Machine Learning and MLOps practices.

> 📄 **Complete Technical Documentation**: See [Karachi_AQI_Predictor_Report_Sumeet_Kumar.pdf](Karachi_AQI_Predictor_Report_Sumeet_Kumar.pdf) for the full project report, including challenges, learnings, and detailed analysis.

## Project Overview

This project forecasts PM 2.5 levels for Karachi, Pakistan up to 72 hours ahead, using:
...
- A real-time dashboard on Streamlit Cloud
...
### 1. Clone Repository
```bash
git clone https://github.com/Sumeet28316/Pearls-AQI-Predictor.git
...
All models are stored in two places:
